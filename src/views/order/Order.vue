      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column prop="pay_status" label="是否付款">
          <template v-slot="scope">
            <el-tag v-if="scope.row.pay_status === 1" type="success" size="mini"
              >已付款</el-tag
            >
            <el-tag size="mini" v-else>未付款</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="is_send" label="是否发货"></el-table-column>
        <el-table-column min-width="165px" prop="create_time" label="创建时间">
          <template v-slot="scope">
...
export default {
  data() {
    return {
      ...
      addressFormRules: {
        address1: [
          { required: true, message: '请选择地区名称', trigger: 'blur' }
        ],
        address2: [
